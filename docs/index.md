---
title: fascat
description: convert CAD STEP data into realtime-ready OpenUSD assets
---

Fascat converts CAD STEP assemblies into realtime-ready OpenUSD assets while preserving hierarchy, materials, transforms, and repeated parts where possible.

## Why fascat

- **Focused** — V1 supports one path well: STEP in, OpenUSD out
